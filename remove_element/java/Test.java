...
public class Test {
    ...
    private static void test_cases() throws Throwable {
        test_case(new Object[]{new int[]{2, 3, 2, 4}, 2}, 2);
        test_case(new Object[]{new int[]{2, 2}, 2}, 0);
    ...
    private static void test_case(Object[] args, Object ret) throws Throwable {
        ...
        try {
            ...
            System.out.println("    elem: " + args[1]);
    ...
    public static void test(Class c) throws Throwable {
        class_ = c;
        method_ = c.getMethod("removeElement", new Class[]{int[].class, int.class});
        test_cases();
    }
