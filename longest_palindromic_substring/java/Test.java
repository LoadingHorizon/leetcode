...
public class Test {
    ...
    private static void test_cases() throws Throwable {
        test_case(new Object[]{"dabcbadef"}, "dabcbad");
        test_case(new Object[]{"bb"}, "bb");
        test_case(new Object[]{"xoox"}, "xoox");
        test_case(new Object[]{"xox"}, "xox");
    ...
    public static void test(Class c) throws Throwable {
        class_ = c;
        method_ = c.getMethod("longestPalindrome", new Class[]{String.class});
        test_cases();
    }
